...
import {readProduct, updateProduct} from './product_api.js'
    ...
    updateProduct({
      ...
      if (err) {
        setValues({...values, error: err})
          ...
          console.log(data)
        setValues({...values,id:data._id, name:data.name,description:data.description,category:data.category,quantity:data.quantity,price:data.price, 'redirect': true})
      }
    })
  }
